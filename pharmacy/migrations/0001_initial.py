# Generated by Django 6.0.6 on 2026-07-04 11:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Clinic Admin'), ('DOCTOR', 'Doctor'), ('PHARMACIST', 'Pharmacist'), ('NURSE', 'Nurse'), ('RECEPTIONIST', 'Receptionist')], default='RECEPTIONIST', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pharmacist', models.ForeignKey(limit_choices_to={'role': 'PHARMACIST'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
